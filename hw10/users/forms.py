...
class RegisterForm(UserCreationForm):
    ...
    password1 = CharField(max_length=20, min_length=4, required=True, widget=PasswordInput(attrs={"class": "form-control"}))
    password2 = CharField(max_length=20, min_length=4, required=True, widget=PasswordInput(attrs={"class": "form-control"}))
